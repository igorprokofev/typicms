...
<div class="row">    
    ...
    <div class="col-sm-6">
        ...
        @if ($model->id)                
            {!! BootForm::select('Parent', 'parent_id')->options(App\CustomMenulink::getParentListSelectOptions($menu, $model))->select($model->parent_id) !!}
        @else                
            {!! BootForm::select('Parent', 'parent_id')->options(App\CustomMenulink::getParentListSelectOptions($menu)) !!}            
        @endif
